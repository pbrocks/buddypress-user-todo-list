...
function bptodo_due_date_metabox() {
	add_meta_box('bptodo-metabox', __( 'Todo Due Date', 'wb-todo' ), 'bptodo_due_date_content', 'bp-todo', 'side', 'high', null);
}
...
function bptodo_due_date_content() {
	...
	?>
	<input type="text" class="todo_due_date" name="todo_due_date" required value="<?php echo $due_date;?>">
	<?php
}
