...
<form action="" method="post">
	<table class="add-todo-block">
		...
		<tr class="add-todo-cat-row">
			<td>
				<input type="text" id="todo-category-name" placeholder="<?php _e('Todo category', 'bptodo');?>">
			</td>
			<td>
				<input type="button" id="add-todo-cat" value="<?php _e('Add', 'bptodo');?>">
				<input type="button" value="<?php _e('Close', 'bptodo');?>" id="todo-cat-close">
			</td>
		</tr>

		<tr>
			<td width="20%">
				<?php _e('Todo Title', 'bptodo');?>
			</td>
			<td width="80%">
				<input value="<?php echo esc_html( $todo->post_title );?>" type="text" placeholder="Todo Title" name="todo_title" required>
			</td>
		</tr>

		<tr>
			<td width="20%">
				<?php _e('Todo Summary', 'bptodo');?>
			</td>
			<td width="80%">
				<textarea placeholder="Todo Summary" name="todo_summary"><?php echo esc_textarea( $todo->post_content ); ?></textarea>
			</td>
		</tr>

		<tr>
			<td width="20%">
				<?php _e('Todo Due Date', 'bptodo');?>
			</td>
			<td width="80%">
		...
		<tr>
			...
			<td width="80%">
				...
				<input type="submit" name="todo_update" value="<?php _e('Update Todo', 'bptodo');?>">
			</td>
		</tr>
	</table>
</form>